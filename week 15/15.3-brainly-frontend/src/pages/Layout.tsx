    ...
    return <div className="min-h-screen bg-white">
        ...
        <div className="w-full mt-6 flex flex-col md:flex-row items-center">
            ...
            <div className="w-full max-w-xs sm:max-w-md md:max-w-md lg:max-w-lg flex justify-center">
                <img className="rounded-full mt-4 sm:mt-8 shadow-md w-full aspect-video object-cover overflow-hidden" src="/src/assets/second.png" />
            </div>
        </div>
        ...
        <div className="w-full min-h-[350px] sm:min-h-[540px] bg-black text-white rounded-t-[2.5rem] sm:rounded-t-[5rem] mt-30">
            <div className="px-4 sm:px-16 md:px-20 lg:ml-28 flex flex-col items-center sm:items-start">
                ...
                <div className="flex flex-col sm:flex-row items-center">
                    <video autoPlay loop playsInline muted className="rounded-full ml-0 sm:ml-12 shadow-lg w-full max-w-xs sm:max-w-sm aspect-video object-cover overflow-hidden" src="/src/assets/Header.mp4"></video>
        ...
        <div className="w-full min-h-40 mt-8">
            <div className="w-full flex flex-col md:flex-row items-center bg-white px-4 sm:px-10 md:px-20 lg:px-40 mt-8 md:mt-20">
                <video autoPlay loop muted playsInline className="border-none bg-white shadow-[0_0_0_0px_white] pt-5 rounded-full w-full max-w-xs sm:max-w-md md:max-w-lg" src="/src/assets/22.mp4"></video>
        ...
        <footer className="w-full bg-white py-4 sm:py-6 border-t border-gray-200 shadow-[0_-2px_12px_0_rgba(0,0,0,0.04)] flex flex-col md:flex-row items-center md:justify-between justify-center gap-2 sm:gap-4 text-gray-600 font-medium text-base sm:text-lg mt-8 sm:mt-10 px-4 sm:px-6">
